          ...
          >
            ...
            <div className="p-6 bg-slate-950 border-t border-slate-900">
              <button
                ...
                className="w-full py-3 rounded-xl bg-slate-900 hover:bg-slate-800 border border-slate-800 hover:border-primary-green text-xs font-semibold text-white tracking-wide transition-all duration-300 cursor-pointer"
              >

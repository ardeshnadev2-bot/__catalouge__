...
export default function GlobalReachMap() {
  ...
  return (
    <section
      id="global-reach"
      className="py-20 lg:py-28 bg-slate-50/40 dark:bg-slate-900/20 border-y border-slate-200/20 dark:border-slate-800/20 text-slate-900 dark:text-white relative overflow-hidden z-10"
    >

...
export default function ClienteleSection() {
  ...
  return (
    <section className="py-16 md:py-24 relative overflow-hidden bg-slate-50/40 dark:bg-slate-900/20 border-y border-slate-200/20 dark:border-slate-800/20 z-10">
